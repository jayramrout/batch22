...
public class HelloWorld {
	...
	static public void main(String[] arg) {
		...
		System.out.println("jrout.tutorial.HelloWorld.main() : Hello Guys..Welcome!!!" + arg[0] +"----"+ arg[1]);
		System.out.println(System.currentTimeMillis());
		
		justPrintMe();
		
		System.out.println(); // sysout ctrl+ space
		System.out.println("jrout.tutorial.HelloWorld.main()"); //systrace
		
	}
	
	public static void justPrintMe(){
		System.out.println("Just print me " + returnYourName());
		System.out.println("jrout.tutorial.HelloWorld.justPrintMe()");
	}
	
	public void imPort(){
		System.out.println("jrout.tutorial.HelloWorld.imPort()");
		System.out.println();
